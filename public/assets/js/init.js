...
jQuery(function ($) {
	...
	fx = {
		...
		// Fades out the window and removes it form the DOM
	...
	$("body").on("click", ".edit-form input[type=submit]", function (event) {
		...
		// If editing an existing event, need to pay attention to the title.
		...
		var formData = $(this).parents("form").serialize(),
			...
			start = $("label>#event_start").val(),

			// Saves the end date input string
			end = $("label>#event_end").val();
